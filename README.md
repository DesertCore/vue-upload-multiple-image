<template>
  <div style="outline: none;">
      ...
      <div class="image-container position-relative text-center" v-if="!images.length">
        <div class="drag-upload-cover position-absolute" v-if="isDragover && isEdittable" @drop="onDrop">
        ...
        <div v-else-if="isEdittable" class="image-center position-absolute display-flex flex-column justify-content-center align-items-center" @dragover.prevent="onDragover">
          <div>
        ...
        <div v-else class="image-center position-absolute display-flex flex-column justify-content-center align-items-center" >
          <div class="text-center">
            <label class="drag-text">{{noImageText}}</label>
            <br>
          </div>
        </div>
      </div>
      ...
      <div class="image-list-container display-flex flex-wrap" v-if="images.length && multiple && isEdittable">
